...
\begin{titlepage}
    ...
    {\Large\textit{An brief introduction to computing, FPGAs and the dream of timeless computers.} \par}
    \vspace{2.5cm}

    {\large\bfseries Written and Edited by\par}
    \vspace{0.5cm}
...
\input{timeless_computing.tex}
\input{electronics.tex}
\input{digital_logic.tex}
\input{computing.tex}
